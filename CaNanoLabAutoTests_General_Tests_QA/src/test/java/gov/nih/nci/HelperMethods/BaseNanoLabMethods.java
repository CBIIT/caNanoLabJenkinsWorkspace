...
public class BaseNanoLabMethods extends BaseTestMethods{
	 ...
	 */
		...
		public void goAppLoginPage() throws TestExecutionException{
			boolean retVal1 = isDisplayed(By.cssSelector("#maincontent > div:nth-child(1) > table > tbody > tr > td.mainContentHomePage > table.gridtableHomePage > tbody > tr:nth-child(2) > td:nth-child(1) > table > tbody > tr:nth-child(1) > td:nth-child(2) > a"));
			if (retVal1 == true){
				click(By.cssSelector("#maincontent > div:nth-child(1) > table > tbody > tr > td.mainContentHomePage > table.gridtableHomePage > tbody > tr:nth-child(2) > td:nth-child(1) > table > tbody > tr:nth-child(1) > td:nth-child(2) > a"));
				boolean retVal2 = isDisplayed(By.linkText("PROTOCOLS"));
				if (retVal2 == true){
		...
		public void writeRestdPass(String getEnv, String getResetPassVal) {
		    String buildFilePath = "//local//content//jenkins//slave1//workspace//_default//_lower//cananolab//My_Frameworks_creds//UserCred//Applications//caNanoLab//passRest_"+ getEnv +".txt"; 
		...
		public String readDoc() {
		    String textCred = "";
		    String f = "//local//content//jenkins//slave1//workspace//_default//_lower//cananolab//My_Frameworks_creds//UserCred//Applications//caNanoLab//uCred.txt";
		    int read, N = 1024 * 1024;
		    char[] buffer = new char[N];
		    try {
		        FileReader fr = new FileReader(f);
	...
	//******
			...
			click(By.cssSelector("button.btn:nth-child(1)"));
			int loadCount = 1000;
			for (int c=1;c<loadCount;c++){
		...
		public void verify_sort_by_created_date() throws TestExecutionException {
			element_load_by_expected_value(By.cssSelector("th.header:nth-child(4) > div:nth-child(1)"), "Created Date");
			...
			if (getCreatedDateVal.isEmpty()==false){
				click(By.cssSelector("html body.ng-scope div.container table tbody tr td#maincontent.mainContent table tbody tr td.mainContent.ng-scope div.spacer.ng-scope span.ng-scope table.table.sample.ng-scope.ng-table thead.ng-scope tr.ng-scope th.header.sortable div.ng-scope.ng-binding"));
				wait_For(3000);
			}
			int loadCreatedDateCount = 100;
			String getCurntCrtdDatVal = null;
			for(int l=1;l<loadCreatedDateCount;l++){
				getCurntCrtdDatVal = null;
				getCurntCrtdDatVal = getText(By.cssSelector("html body.ng-scope div.container table tbody tr td#maincontent.mainContent table tbody tr td.mainContent.ng-scope div.spacer.ng-scope span.ng-scope table.table.sample.ng-scope.ng-table thead.ng-scope tr.ng-scope th.header.sortable div.ng-scope.ng-binding"));
		...
		public void cananolab_search(String vSearchEle, 
			...
			if (vSearchEle.isEmpty()==false){
				if (vSearchEle.equals("Yes")){
					...
					//element_display(By.id("searching"));
				}
			}
			//Enter Search Term
			...
			if (getSearchVal.isEmpty()==false){
				...
				click(By.cssSelector("button.btn:nth-child(2)"));
				}
			}
			//Verify Search
		...
		public void samples_search_simple (String keyword, String SampleNameDropDown, String SampleName, String SamplePointofDropDown, String SamplePointof, String NanomaterialEntity, String FunctionalizingEntity, String Function, String CharacterizationType, String Characterization, String SearchOrReset) throws TestExecutionException {
			String btnVerification = "button.btn:nth-child(2)"; // Submit button verification
		...
		public void Verify_sample_search_by_publication_PubMed_ID_as_a_Researcher(String pbmedid, String txtVerification) throws TestExecutionException {
			...
			enter(By.id("id"),pbmedid);
			choosePublicationType("PubMed");
			click(By.cssSelector("#maincontent > table > tbody > tr:nth-child(2) > td > div > div > div.form__actions > div > div > button.btn.btn-primary"));
			try{
				waitUntil(By.cssSelector(".table.publication tbody tr th:nth-child(1)"),"Publication REF");
				waitUntil(By.cssSelector(".table.publication tbody tr th:nth-child(2)"),"Authors");
				waitUntil(By.cssSelector(".table.publication tbody tr th:nth-child(3)"),"Title");
		...
		public void verify_publication_search_by_keyword_as_a_Researcher(String keywrd) throws TestExecutionException {
			...
			//Enter search term
			enter(By.id("keywordsStr"), keywrd);
			click(By.cssSelector("#maincontent > table > tbody > tr:nth-child(2) > td > div > div > div.form__actions > div.form__action__right > button.btn.btn-primary"));
			//Wait for Publication Search Result
			Verify_publication_search_result_table();
			int resultCount = getRowCount(By.cssSelector(".table.sample.ng-scope.ng-table"));
			int totalDisplayResults = resultCount - 2;
